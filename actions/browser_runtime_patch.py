...
def _play_spotify_track(self: BrowserActions, track: str) -> bool:
    ...
    if not track:
        return False
    try:
        url = "https://open.spotify.com/search/" + urllib.parse.quote(track)
        page = self._page()
